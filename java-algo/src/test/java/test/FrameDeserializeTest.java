...
public class FrameDeserializeTest {
    ...
    public void test() {
        String configData = "{\n" +
                ...
                "  }\n" +
                "}\n";
        String frameData = "{\"p2Units\":[[],[],[],[],[],[],[],[]],\"turnInfo\":[0,0,-1,0],\"p1Stats\":[30.0,40.0,5.0,0],\"p1Units\":[[],[],[],[],[],[],[],[]],\"p2Stats\":[30.0,40.0,5.0,0],\"events\":{\"selfDestruct\":[],\"breach\":[],\"damage\":[],\"shield\":[],\"move\":[],\"spawn\":[],\"death\":[],\"attack\":[],\"melee\":[]}}\n";
